...
function assessRugRisk({ snapshot, liqMcPct, mintAuthorityStatus, rugCheckReport }) {
  ...
  const mintActive = authorityKnown
    ? (mintAuthorityStatus?.available ? mintAuthorityStatus.mintAuthority != null : snapshot.mintAuthority != null)
    : null;
  const freezeActive = authorityKnown
    ? (mintAuthorityStatus?.available ? mintAuthorityStatus.freezeAuthority != null : snapshot.freezeAuthority != null)
    : null;
