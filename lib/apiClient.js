...
async function getRugCheckReport(
   ...
   * Full report FIRST.
   *
   * /report contains the topHolders array used
   * to calculate top holder / top 10 / top 20.
   */
  for (
    const suffix of [
      "/report",
...
// -----------------------------------------------------------------------------
//
// Uses Solscan's free Token Meta playground route.
//
// We use it ONLY for total holder count.
// Top-holder concentration comes from RugCheck.
// -----------------------------------------------------------------------------
