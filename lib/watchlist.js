...
class Watchlist {
  ...
  async _assessRug(
    ...
    /*
     * Use the authority data already collected
     * by snapshotBuilder whenever possible.
     *
     * This avoids an unnecessary Helius call.
     */
    ...
    /*
     * Only request authority data again if
     * snapshotBuilder couldn't obtain it.
     */
